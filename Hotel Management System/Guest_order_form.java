...
public class Guest_order_form  
{
    ...
    public Guest_order_form() 
    {
        ...
        try
        {
            ...
            //QUERY IS USED TO SELECT ALL ITEMS FROM THE FOOD TABLE
         ...
         c0_table_no.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try
                {
                    ...
                    if(table_found==0)
                    {
                        String query3="create table "+table_no+" (item_no varchar(10)  ,item_name varchar(50) primary key,quantity varchar(50),rate varchar(10),amount varchar(10),served_quantity int(5) default 0);";
