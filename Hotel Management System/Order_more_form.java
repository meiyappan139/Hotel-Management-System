...
public class Order_more_form
{
    JLabel l1_table_no,l2_customer_name,l3_item_name,l4_quantity,l5_subtotal,l6_net_total,l7_recieved_amount,l8_due_amount,l9_remove_lbl;
    JTextField t0_date_time,t1_table_no,t2_customer_name,t5_subtotal,t6_net_total,t7_recieved_amount,t8_due_amount;
    JButton b1_add_item_btn,b2_order_now,b3_bill,b4_remove,b5_back_button;
    ...
    public Order_more_form(String name,String tabl) 
    {
         frame=new JFrame();
         frame.setTitle("ORDER MORE ITEM");
        ...
        b5_back_button=new JButton("BACK");
        
        t1_table_no.setEditable(false);
        t1_table_no.setText(tabl);
       ...
       //INSERT BUTTON 
        ...
        t1_table_no.setBounds(180, 70, 150, 30);
        t1_table_no.setFont(new Font("verdana",Font.BOLD,15));
        ...
        table.setGridColor(Color.red);
         ...
         b5_back_button.setBounds(50,560,200,30);
         b5_back_button.setFont(new Font("verdana", Font.BOLD, 20));
         ...
         b5_back_button.addActionListener(new ActionListener() {

             @Override
             public void actionPerformed(ActionEvent e) {
                 frame.setVisible(false);
                 new Option_page(name, tabl);
             }
         });
                   ...
                   ResultSet rs1=st.executeQuery(query1);
                        ...
                        while(rs1.next())
                        {
                            ...
                            else                               
                            {
                                ...
                                {
                                    System.out.println("inside udating table");
                                ...
                                double n_amount=res+amount1;int net_amount=(int)n_amount;
    ...
    b4_remove.addActionListener(new ActionListener() {
             ...
             public void actionPerformed(ActionEvent e) {
                 ...
                 else
                 {
                     ...
                     try
                     {
                         ...
                         //QUER2 IS USED TO UPDATE AVAILABLE QUANTITY IN FOOD TABLE
                         ...
                         else
                         {
                             ...
                             String que="update "+table_no+" set quantity="+s+",amount="+s+" where item_name='"+selected_food+"' ";
        ...
        frame.add(b4_remove);
        frame.add(b5_back_button);
        frame.add(c1_food_items);
        frame.add(t1_table_no);
    ...
    {   
         ...
         try
         {
            ...
            Connection conn=Bean.getConnection();
             ...
             while(rs.next())
             {
                 ...
                 int av=Integer.parseInt(quantity);
                 String rate=rs.getString("rate");
                 String price=rs.getString("amount");
                 if(av!=0)
                 {
                     ok++;
                     System.out.println("ok insert: "+ok);
       ...
       {
           ok--;
           System.out.println("ok delete: "+ok);
           try
           {
    ...
    {
       new Order_more_form("mvp","a1");                   //SHOULD NOT RUN ALONE
    }
}
